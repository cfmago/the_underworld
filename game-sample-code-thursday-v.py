...
object_relations = {
    ...
    "door a": [game_room, bedroom_1], # bedroom_1 replaces outside 
    ...
    "devil":[underworld,bedroom_2,game_room]
} 
...
def examine_item(item_name):
    ...
    if(current_room["name"] == "underworld"):
        output = "Do you want to make a pact?"
